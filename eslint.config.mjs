...
export default defineConfig(
  ...
  },
  {
    ...
    languageOptions: {
      parserOptions: {
        project: true,
        tsconfigRootDir: process.cwd(), // Since eslint is always run from the projects' roots, this makes sure we always look for a tsconfig there
      },
    },
  },
  {
    ...
    rules: {
      ...
      // TypeScript already checks for unused variables and we don't use any features that only ESLint covers.
